...
### Proyecto de Tesis: Inteligencia Artificial para la Retención Estudiantil
**Autor:** Farid Sandoval (Support Teacher - Colombo Americano Cali)
...
## ⚙️ Instrucciones para Colaboradores (Equipo de Tesis)
